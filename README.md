...
## Current development
Current development is the Meteor 1.2 ES2015 localstorage version `ground:db@1.0.0-alpha.x` [branch](https://github.com/GroundMeteor/db/tree/es2015-localforage) is tracked in [#118](https://github.com/GroundMeteor/db/issues/118)
